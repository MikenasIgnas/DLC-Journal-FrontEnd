  ...
  return (
    <div className='DLCJournalStartPageContainer'>
      <div className='DisplayFlex'>
        ...
        {!isSecurity ? <JournalStartPageCard icon={<UnorderedListOutlined/>} navigateLink={'/DLC Žurnalas/Įmonių_Sąrašas?page=1&limit=10&tableSorter=desc'} buttonText={'Įmonių sąrašas'}/> : null}
      </div>
      {
        !isSecurity ?
          <div className='DisplayFlex'>
